        ...
        <div class=" col-lg-4 ">
          <div class=" card mb-4 border-danger" style="background-color: black; color:white">
            <div class=" card-body text-center">
              <?php if ($_SESSION['pfp'] == "") { ?>
                <img src="../assets/img/userimg/pepe.jpg" class="rounded-circle img-fluid" style="width: 150px;">
              <?php } else {
                $image_data = base64_encode($_SESSION['pfp']);
                $image_type = "jpeg"; // Cambiar según el tipo de imagen almacenado en la base de datos
                echo '<img src="data:image/' . $image_type . ';base64,' . $image_data . '" class="rounded-circle img-fluid " style="width: 150px;">';
              }
              ?>
              ...
              <div class="row">
                ...
                <div class="col-sm-9">
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="profileGender" id="maleRadio" value="male" <?php if ($_SESSION['gender'] == 'male') {
                                                                                                                    echo ' checked';
                                                                                                                  } ?>>
                  ...
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="profileGender" id="femaleRadio" value="female" <?php if ($_SESSION['gender'] == 'female') {
                                                                                                                        echo ' checked';
                                                                                                                      } ?>>
                  ...
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="profileGender" id="otherRadio" value="other" <?php if ($_SESSION['gender'] == 'other') {
                                                                                                                      echo ' checked';
                                                                                                                    } ?>>
              ...
              <div class="row">
                ...
                <div class="col-sm-9">
                  <select name="profileCountry" class="bg bg-dark text-white form-select" aria-label="Choose a Country">
                    ...
                    <option value="argentina" <?php if ($_SESSION['country'] == 'argentina') {
                                                echo ' selected';
                                              } ?>>Argentina</option>
                    <option value="brazil" <?php if ($_SESSION['country'] == 'brazil') {
                                              echo ' selected';
                                            } ?>>Brazil</option>
                    <option value="colombia" <?php if ($_SESSION['country'] == 'colombia') {
                                                echo ' selected';
                                              } ?>>Colombia</option>
                    <option value="spain" <?php if ($_SESSION['country'] == 'spain') {
                                            echo ' selected';
                                          } ?>>Spain</option>
                    <option value="france" <?php if ($_SESSION['country'] == 'france') {
                                              echo ' selected';
                                            } ?>>France</option>
                    <option value="italy" <?php if ($_SESSION['country'] == 'italy') {
                                            echo ' selected';
                                          } ?>>Italy</option>
                    <option value="mexico" <?php if ($_SESSION['country'] == 'mexico') {
                                              echo ' selected';
                                            } ?>>Mexico</option>
                    <option value="peru" <?php if ($_SESSION['country'] == 'peru') {
                                            echo ' selected';
                                          } ?>>Peru</option>
                    <option value="portugal" <?php if ($_SESSION['country'] == 'portugal') {
                                                echo ' selected';
                                              } ?>>Portugal</option>
                    <option value="uruguay" <?php if ($_SESSION['country'] == 'uruguay') {
                                              echo ' selected';
                                            } ?>>Uruguay</option>
                  </select>
                </div>
